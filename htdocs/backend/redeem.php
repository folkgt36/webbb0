...
<body>
    ...
    <form data-form="key_point">
        <div class="modal fade" id="CreateRedeemCodeModal" aria-hidden="true" aria-labelledby="44GAMESHOPModalToggleLabel"
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="44GAMESHOPModalToggleLabel">Create Redeem Code</h5>
