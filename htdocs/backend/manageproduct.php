...
<body>
    ...
    <form data-form="Cargo_Add">
        <div class="modal fade" id="addcargomodal" aria-hidden="true" aria-labelledby="44GAMESHOPModalToggleLabel"
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="44GAMESHOPModalToggleLabel">Add Cargo</h5>
    ...
    <form data-form="edititemqq">
        <div class="modal fade" id="editItemModal" aria-hidden="true" aria-labelledby="44GAMESHOPModalToggleLabel"
            tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
